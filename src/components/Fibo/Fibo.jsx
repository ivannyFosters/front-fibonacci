...
const FibonacciApp = () => {
  ...
  const calculateFibo = () => {
    ...
    let newfibonacci = fibonacci.slice(-2),
  ...
  function getFibonacciNumber(data) {
    document.getElementsByClassName(
      "fibo-container-result__results"
    )[0].innerHTML = data;
  }
    ...
    <div>
      ...
      <div className="fibo-container-buttons">
        <input
          ...
          className="fibo-container-input"
          type="number"
          placeholder="Add number..."
        ></input>
        <button className="fibo-container-submit" onClick={calculateFibo}>
          Calculate
        </button>
      </div>
      <p className="fibo-container-result">
        Fibonacci Result:{" "}
        <span className="fibo-container-result__results">0</span>
      </p>
    </div>
  );
};
